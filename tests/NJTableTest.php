 ...
 * @Last Modified time: 2014-12-30 00:32:23
 */
...
class NJTableTest extends PHPUnit_Framework_TestCase {
  public function testTableTest() {
    ...
    $tbl->field('field_1')->setType('int', 11, true)->setNotNull()->default(1)->comment('这是个注释');
    $tbl->field('field_2')->setType('int', 11);
    $tbl->field('field_3')->setType('varchar', 256);
