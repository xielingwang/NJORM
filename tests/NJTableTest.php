 ...
 * @Last Modified time: 2014-12-27 15:00:08
 */
...
class NJTableTest extends PHPUnit_Framework_TestCase {
  public function testTableTest() {
    ...
    $this->assertEquals('SELECT `t1`.`pk1` `sa1`,`t1`.`pk2` `sa2`,`t1`.`longkey1` `sa3`,`t1`.`created_time` `ct`,`t1`.`updated_time` `ut`', $tbl->select_star('t1'));
  }
}